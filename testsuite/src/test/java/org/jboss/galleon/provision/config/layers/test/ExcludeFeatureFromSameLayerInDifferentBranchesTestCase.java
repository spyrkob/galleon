 ...
 */
public class ExcludeFeatureFromSameLayerInDifferentBranchesTestCase extends ProvisionFromUniverseTestBase {
    ...
    protected ProvisioningConfig provisioningConfig() throws ProvisioningException {
        return ProvisioningConfig.builder()
                .addFeaturePackDep(FeaturePackConfig.builder(prod1).setInheritConfigs(false).setInheritPackages(false).build())
